...
import { ownRestaurantInitialDataComposable } from '../../../own-restaurant/restaurant/initial/own-restaurants-initial-data.composable';
...
export const restaurantFormDataSubmitterComposable = async () => {
    ...
    if (status) {
        ...
        if (response!.errors) {
            ...
            await ownRestaurantInitialDataComposable(1);
            ui.closePopup();
        }
    }
};
