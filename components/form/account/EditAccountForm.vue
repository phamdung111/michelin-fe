    ...
    <div v-if="user.id">
        <div class="grid md:flex mb-[30px]">
            <div class="flex basis-[150px] flex-col justify-between items-center text-center">
                ...
                <input @input="isSelectFile()" ref="fileInput" type="file" id="fileInput" style="display: none" />
            </div>
        ...
        <div>
            <div class="pb-[24px] border-b">
                ...
                <div class="grid mb-4">
                    ...
                    <input v-model="form.email" class="border h-[45px] tex-[14px] p-4 focus:outline-none rounded-md px-2" type="text" />
                </div>
                <div class="grid mb-4">
                    ...
                    <input v-model="form.name" class="border h-[45px] focus:outline-none rounded-md px-2" type="text" />
                </div>
                <div class="grid mb-4">
                    ...
                    <input v-model="form.phone" class="border h-[45px] focus:outline-none rounded-md px-2" type="text" />
                </div>
            </div>
            <div class="py-[24px] border-b">
                ...
                <div class="grid mb-4">
                    ...
                    <input v-model="form.currentPassword" class="border h-[45px] focus:outline-none rounded-md px-2" type="text" />
                </div>
                <div class="grid mb-4">
                    ...
                    <input v-model="form.newPassword" class="border h-[45px] focus:outline-none rounded-md px-2" type="text" />
                </div>
                <div class="grid mb-4">
                    ...
                    <input v-model="form.repeatPassword" class="border h-[45px] focus:outline-none rounded-md px-2" type="text" />
                </div>
            </div>
        </div>
    ...
    <div v-if="openCropper" class="fixed w-screen h-screen top-0 left-0">
        <div class="flex justify-center items-center w-full h-full">
            <div class="px-[134px] py-[88px] bg-white shadow-2xl border rounded-xl relative">
                <Icon class="absolute top-0 right-0 text-primaryColor6" name="mdi:close" />
                ...
                <div @click.prevent="getCroppedImage()" class="flex justify-center mt-[32px]">
...
export default defineComponent({
    ...
    setup() {
        ...
        const updateAccount = () => {
            accountFormSubmitterComposable();
        };
        const isSelectFile = () => {
        ...
        const getCroppedImage = () => {
            if (cropper!.value) {
                ...
                context?.drawImage(image, coordinates.left, coordinates.top);
